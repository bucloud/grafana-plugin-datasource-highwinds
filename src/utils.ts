...
export const statusMetrics = [
    ...
    { label: "RequestPerSecond", value: "rps", description: "requests per second, calculated as total requests divided by number of seconds in bucket" }
];
...
export const transferMetrics = [
    ...
    { value: "xferRateMaxUsageTime", description: "timestamp at which maximum transfer rate occurred", label: "xferRateMaxUsageTime" },
    { value: "xferRateMinMbps", description: "minimum transfer rate", label: "xferRateMinMbps" },
    { value: "xferRateMinUsageTime", description: "timestamp at which minimum transfer rate occurred", label: "xferRateMinUsageTime" },
    { value: "xferRateMeanMbps", description: "average transfer rate", label: "xferRateMeanMbps" },
    { value: "requestsCountMin", description: "minimum five minute bucket of requests per second", label: "requestsCountMin" },
    { value: "requestsCountMax", description: "maximum five minute bucket of requests per second", label: "requestsCountMax" },
    { value: "requestsCountMean", description: "average of five minute bucket requests per second", label: "requestsCountMean" },
    { value: "rpsMax", description: "maximum requests per second", label: "rpsMax" },
    { value: "rpsMaxUsageTime", description: "timestamp at which maximum requests per second occurred", label: "rpsMaxUsageTime" },
    { value: "rpsMin", description: "minimum requests per second", label: "rpsMin" },
    { value: "rpsMinUsageTime", description: "timestamp at which minimum requests per second occurred", label: "rpsMinUsageTime" },
    ...
    { value: "completionRatio", description: "completed requests divided by attempted requests", label: "completionRatio" },
    { value: "responseSizeMeanMB", description: "total MB transferred divided by number of requests", label: "responseSizeMeanMB" },
    { value: "peakToMeanMBRatio", description: "maximum transfer rate divided by mean transfer rate", label: "peakToMeanMBRatio" },
    { value: "peakToMeanRequestsRatio", description: "maximum requests per second divided by mean requests per second", label: "peakToMeanRequestsRatio" },
    ...statusMetrics
];

export const storageMetrics = [
    { value: "edgeStorageTotalB", description: "total bytes stored on every edge, may contain duplicate assets", label: "edgeStorageTotalB" },
    { value: "edgeStorageMaxB", description: "maximum five minute bucket of bytes stored", label: "edgeStorageMaxB" },
    { value: "edgeStorageMaxUsageTime", description: "timestamp at which maximum bytes stored occurred", label: "edgeStorageMaxUsageTime" },
    { value: "edgeStorageMinB", description: "minimum five minute bucket of bytes stored", label: "edgeStorageMinB" },
    { value: "edgeStorageMinUsageTime", description: "timestamp at which minimum bytes stored occurred", label: "edgeStorageMinUsageTime" },
    { value: "edgeStorageMeanB", description: "average of five minute bucket bytes stored", label: "edgeStorageMeanB" },
    { value: "edgeFileCountTotal", description: "total assets stored on every edge, may contain duplicate assets", label: "edgeFileCountTotal" },
    { value: "edgeFileCountMax", description: "maximum five minute bucket of files stored", label: "edgeFileCountMax" },
    { value: "edgeFileCountMaxUsageTime", description: "timestamp at which maximum files stored occurred", label: "edgeFileCountMaxUsageTime" },
    { value: "edgeFileCountMin", description: "minimum five minute bucket of files stored", label: "edgeFileCountMin" },
    { value: "edgeFileCountMinUsageTime", description: "timestamp at which minimum files stored occurred", label: "edgeFileCountMinUsageTime" },
...
export const statusFilter = [
    ...
    { value: "statusCategories", description: "1 digit http status codes categories to filter by", label: "StatusCategories" },
    ...commonFilter
]
...
export function intervalMsToGranularity(interval: number=1000){
